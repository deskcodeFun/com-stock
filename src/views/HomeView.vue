<template>
  ...
  <div class="bg-amber-200 w-screen my-8 flex flex-row flex-wrap justify-center">
    <div class="bg-green-800 w-fit" v-for="user in users" key:user.id>
      <div class="bg-white border-2 border-gray-200 rounded-2xl w-xl mx-4 my-4 py-4 px-4">
        <table>
          <tbody>
            <tr>
              <img src="\src\assets\images\hp1.png" alt="computer image" width="320" />
            </tr>
            <tr>
